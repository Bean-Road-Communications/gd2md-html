...
*   The source code to Docs to Markdown is in the `addon/` directory at [https://github.com/Bean-Road-Communications/gd2md-html](https://github.com/Bean-Road-Communications/gd2md-html). Fork the gd2md-html project into your own repository.
...
There is an existing feature request for Markdown table output. This should be possible, but not that useful, since Markdown tables cannot handle complex tables that are possible in Google Docs or HTML.
...
Existing open issues for Docs to Markdown are at [/evbacher/gd2md-html/issues](https://github.com/evbacher/gd2md-html/issues).

If you find a new bug or feature request, please file it against the Bean Road Communications [gd2md-html repository](https://github.com/Bean-Road-Communications/gd2md-html/issues/new).
